...
def run_migrations_online() -> None:
    ...
    with connectable.connect() as connection:
        ...
        # SQLAlchemy 2.x requires raw SQL wrapped in text(); commit is needed
        # because DDL outside an explicit transaction would otherwise be left
        # uncommitted on the connection.
        if is_postgresql:
            try:
